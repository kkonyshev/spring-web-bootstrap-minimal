...
<head>
    ...
    <link href="datatables-1.10.6/extensions/integration/bootstrap/3/dataTables.bootstrap.css" rel="stylesheet">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="#datatable">Datatable example</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <script src="datatables-1.10.6/extensions/integration/bootstrap/3/dataTables.bootstrap.js"></script>
